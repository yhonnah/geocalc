...
ASSETS_PATH = OUTPUT_PATH / Path(r"C:\Users\Arjhay Sebua\Desktop\Calculator GUI\build\assets\frame4")
...
def triangularPrismSides(a, b, c, height, length, width):
    ...
    perimeter = triangularPrismSidesPerimeter
    triangularPrismArea = (length * perimeter) + (height * width)
    triangularPrismVolume = (width * height * length) / 2
    return triangularPrismSidesPerimeter, triangularPrismArea, triangularPrismVolume
...
def calculate_triangular_prism():
    try:
        ...
        # Assuming a, b, c are the sides of the base triangle, we need to calculate the perimeter.
        # For simplicity, we'll set all sides equal to width
        a = b = c = width
...
button_1 = Button(
    ...
    borderwidth=0,
    highlightthickness=0,
    command=calculate_triangular_prism,
    relief="flat"
)
button_1.place(
    x=363.0,
